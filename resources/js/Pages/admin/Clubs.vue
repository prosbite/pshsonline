<template>
    <MainLayout>
        <div
            class="w-full bg-white p-8 rounded-xl shadow-md border border-gray-200"
        >
            <div
                class="flex flex-col md:flex-row md:items-center md:justify-between mb-4 space-y-4 md:space-y-0"
            >
                <!-- Left: Title -->
                <div>
                    ...
                    <p class="text-gray-600 text-sm">
                        Available clubs this school year
                        {{ page.props.sy.year_start }} -
                        {{ page.props.sy.year_end }}
                    </p>
                </div>
                ...
                <div class="flex flex-wrap gap-4">
                    <Link
                        ...
                        class="bg-blue-500 text-white px-4 py-3 rounded-lg shadow-sm hover:bg-blue-600 transition-colors duration-200 flex items-center"
                    >
                        <svg
                    ...
                    <a
                        href="#"
                        class="bg-green-100 text-green-800 px-4 py-3 rounded-lg shadow-sm hover:bg-green-200 transition-colors duration-200 cursor-pointer"
                    >
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th
                                scope="col"
                                class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-6 hover:text-blue-500 cursor-pointer"
                                @click="sortBy = 'name'"
                            >
                                Club Name
                            </th>
                            <th
                                scope="col"
                                class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hover:text-blue-500 cursor-pointer"
                        ...
                        >
                            ...
                            >
                                <div class="flex flex-col">
                                    <span class="font-semibold text-lg">{{
                                        ucWords(club.club.name ?? "")
                                    }}</span>
                                    <span class="text-gray-500 text-sm"
                                        >Adviser: {{ club.user.name }}</span
                                    >
                                </div>
                            </td>
                            <td
                            ...
                            >
                                ...
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        class="h-7 hover:text-white text-blue-100 cursor-pointer"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                    >
                                ...
                                <button
                                    ...
                                    "
                                    class="px-3 py-1 bg-green-500 text-white text-xs font-semibold rounded-lg shadow-md hover:bg-green-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                                >
                                    <svg
                                        width="24"
                                        height="24"
                                    ...
                                    >
                                        ...
                                        />
                                        <path
                                            d="M32 30l6 6-10 10H22v-6l10-10z"
                                            stroke="black"
                                            stroke-width="2"
                                            fill="none"
                                        />
