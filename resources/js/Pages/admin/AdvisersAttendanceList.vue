            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody v-if="props.attendances.length > 0" class="bg-white divide-y divide-gray-200">
                    <tr v-for="(attendance, index) in props.attendances" :key="index">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-left text-sm text-gray-500">{{ attendance.type }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-left text-sm text-gray-500">{{ attendance.activity }}</td>
