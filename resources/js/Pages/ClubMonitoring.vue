                ...
                <div class="overflow-x-auto rounded-lg shadow">
                    <table class="min-w-full border border-gray-200 bg-white">
                        ...
                        <tr>
                            ...
                            <td class="px-2 py-2 text-center text-sm border-r">{{ rating(ipcr?.monitoring?.target_1.t) }}</td>
                            <td class="px-2 py-2 text-center text-sm border-r">{{ setAvg(ipcr?.monitoring?.target_1.q, ipcr?.monitoring?.target_1.e, ipcr?.monitoring?.target_1.t) }}</td>
                            <td class="px-2 py-2 text-left text-sm border-r">{{ ipcr?.monitoring?.target_1.remarks ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td class="px-4 py-3 text-sm text-gray-700 font-medium border-r border-gray-200 max-w-72">
                            ...
                            <td class="px-2 py-2 text-center text-sm border-r">{{ rating(ipcr?.monitoring?.target_2.t) }}</td>
                            <td class="px-2 py-2 text-center text-sm border-r">{{ setAvg(ipcr?.monitoring?.target_2.q, ipcr?.monitoring?.target_2.e, ipcr?.monitoring?.target_2.t) }}</td>
                            <td class="px-2 py-2 text-left text-sm border-r">{{ ipcr?.monitoring?.target_2.remarks ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td class="px-4 py-3 text-sm text-gray-700 font-medium border-r border-gray-200 max-w-72">
                            ...
                            <td class="px-2 py-2 text-center text-sm border-r">{{ rating(ipcr?.monitoring?.target_3.t) }}</td>
                            <td class="px-2 py-2 text-center text-sm border-r">{{ setAvg(ipcr?.monitoring?.target_3.q, ipcr?.monitoring?.target_3.e, ipcr?.monitoring?.target_3.t) }}</td>
                            <td class="px-2 py-2 text-left text-sm border-r">{{ ipcr?.monitoring?.target_3.remarks ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td class="px-4 py-3 text-sm text-gray-700 font-medium border-r border-gray-200 max-w-72">
                            ...
                            <td class="px-2 py-2 text-center text-sm border-r">{{ rating(ipcr?.monitoring?.target_4.t) }}</td>
                            <td class="px-2 py-2 text-center text-sm border-r">{{ setAvg(ipcr?.monitoring?.target_4.q, ipcr?.monitoring?.target_4.e, ipcr?.monitoring?.target_4.t) }}</td>
                            <td class="px-2 py-2 text-left text-sm border-r">{{ ipcr?.monitoring?.target_4.remarks ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td class="px-4 py-3 text-sm text-gray-700 font-medium border-r border-gray-200 max-w-72">
                            ...
                            <td class="px-2 py-2 text-center text-sm border-r">{{ rating(ipcr?.monitoring?.target_5.t) }}</td>
                            <td class="px-2 py-2 text-center text-sm border-r">{{ setAvg(ipcr?.monitoring?.target_5.q, ipcr?.monitoring?.target_5.e, ipcr?.monitoring?.target_5.t) }}</td>
                            <td class="px-2 py-2 text-left text-sm border-r">{{ ipcr?.monitoring?.target_5.remarks ?? '-' }}</td>
                        ...
                        <tr>
                            ...
                            <td class="px-2 py-2 text-center text-sm border-r">{{ rating(ipcr?.monitoring?.target_6.t) }}</td>
                            <td class="px-2 py-2 text-center text-sm border-r">{{ setAvg(ipcr?.monitoring?.target_6.q, ipcr?.monitoring?.target_6.e, ipcr?.monitoring?.target_6.t) }}</td>
                            <td class="px-2 py-2 text-left text-sm border-r">{{ ipcr?.monitoring?.target_6.remarks ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td class="px-4 py-3 text-sm text-gray-700 font-medium border-r border-gray-200 max-w-72">
                            ...
                            <td class="px-2 py-2 text-center text-sm border-r">{{ rating(ipcr?.monitoring?.target_7.t) }}</td>
                            <td class="px-2 py-2 text-center text-sm border-r">{{ setAvg(ipcr?.monitoring?.target_7.q, ipcr?.monitoring?.target_7.e, ipcr?.monitoring?.target_7.t) }}</td>
                            <td class="px-2 py-2 text-left text-sm border-r">{{ ipcr?.monitoring?.target_7.remarks ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td class="px-4 py-3 text-sm text-gray-700 font-medium border-r border-gray-200 max-w-72">
                            ...
                            <td class="px-2 py-2 text-center text-sm border-r">{{ rating(ipcr?.monitoring?.target_8.t) }}</td>
                            <td class="px-2 py-2 text-center text-sm border-r">{{ setAvg(ipcr?.monitoring?.target_8.q, ipcr?.monitoring?.target_8.e, ipcr?.monitoring?.target_8.t) }}</td>
                            <td class="px-2 py-2 text-left text-sm border-r">{{ ipcr?.monitoring?.target_8.remarks ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td class="px-4 py-3 text-sm text-gray-700 font-medium border-r border-gray-200 max-w-72">
                            ...
                            <td class="px-2 py-2 text-center text-sm border-r">{{ rating(ipcr?.monitoring?.target_9.t) }}</td>
                            <td class="px-2 py-2 text-center text-sm border-r">{{ setAvg(ipcr?.monitoring?.target_9.q, ipcr?.monitoring?.target_9.e, ipcr?.monitoring?.target_9.t) }}</td>
                            <td class="px-2 py-2 text-left text-sm border-r">{{ ipcr?.monitoring?.target_9.remarks ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td class="px-4 py-3 text-sm text-gray-700 font-medium border-r border-gray-200 max-w-72">
                                <div class="flex flex-col justify-start items-start gap-2">
                            ...
                            <td class="px-2 py-2 text-center text-sm border-r">{{ rating(ipcr?.monitoring?.target_10.t) }}</td>
                            <td class="px-2 py-2 text-center text-sm border-r">{{ setAvg(ipcr?.monitoring?.target_10.q, ipcr?.monitoring?.target_10.e, ipcr?.monitoring?.target_10.t) }}</td>
                            <td class="px-2 py-2 text-left text-sm border-r">{{ ipcr?.monitoring?.target_10.remarks ?? '-' }}</td>
                        ...
                        <tr>
                            ...
                            <td class="px-2 py-2 text-center text-sm border-r">{{ rating(ipcr?.monitoring?.target_11.t) }}</td>
                            <td class="px-2 py-2 text-center text-sm border-r">{{ setAvg(ipcr?.monitoring?.target_11.q, ipcr?.monitoring?.target_11.e, ipcr?.monitoring?.target_11.t) }}</td>
                            <td class="px-2 py-2 text-left text-sm border-r">{{ ipcr?.monitoring?.target_11.remarks ?? '-' }}</td>
...
import { rating, getAverage } from '@/composables/utilities';
...
const setAvg = (x: number, y: number, z: number) => {
    let arr = []
    if(x > 0) {
        arr.push(x)
    }
