    ...
    <nav class="space-y-4 flex-grow">
        ...
        <div v-if="user.role === 'admin'" class="relative">
            ...
            <div v-if="isClubManagementGroupOpen" class="pl-8 space-y-2 mt-2">
                ...
                <Link v-if="user.role === 'admin'" :href="route('admin.attendance.infractions')" :class="{'bg-gray-700': route().current('admin.attendance.infractions')}" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-700 transition-colors duration-200 group">
                    <svg class="w-5 h-5 text-red-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M12 9v3m0 4h.01M10.29 3.86L1.82 18a1.5 1.5 0 001.29 2.25h18.78a1.5 1.5 0 001.29-2.25L13.71 3.86a1.5 1.5 0 00-2.42 0z"/>
                    </svg>
        ...
        <div v-if="user.role === 'club adviser'" class="relative">
            ...
            <div v-if="isClubManagementGroupOpen" class="pl-8 space-y-2 mt-2">
                <Link :href="route('club.attendance.create', { club_register_id: clubRegisterId })" :class="{'bg-gray-700': route().current('club.attendance.create')}" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-700 transition-colors duration-200 group">
                    <span class="text-md">New Attendance</span>
                </Link>
            </div>
            <div v-if="isClubManagementGroupOpen" class="pl-8 space-y-2 mt-2">
        ...
        <!-- <Link v-if="user.role === 'club adviser'" :href="route('club.accomplishment.quarterly', { club_register_id: clubRegisterId })" :class="{'bg-gray-700': route().current('club.accomplishment.quarterly')}" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-700 transition-colors duration-200 group">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" role="img" aria-labelledby="title">
                <title id="title">Accomplishment Report</title>
        ...
        <Link v-if="user.role === 'club adviser'" :href="route('club.monitoring.show', { id: clubRegisterId })" :class="{'bg-gray-700': route().current('club.monitoring.show', { id: clubRegisterId })}" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-700 transition-colors duration-200 group">
                    <!-- save as monitor-monitoring-outline.svg -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 64 64" aria-hidden="true">
                    <g fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <!-- monitor outline -->
        ...
        <div v-if="user.role === 'club adviser'" class="relative">
            ...
            <div v-if="isClubReportsGroupOpen" class="pl-8 space-y-2 mt-2">
                <Link :href="route('club.attendance.monthly', { club_id: clubRegisterId })" :class="{'bg-gray-700': route().current('club.attendance.monthly')}" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-700 transition-colors duration-200 group">
                    <span class="text-md">Monthly Attendance Report</span>
                </Link>
            </div>
            <div v-if="isClubReportsGroupOpen" class="pl-8 space-y-2 mt-2">
                <Link :href="route('club.accomplishment.quarterly', { club_id: clubRegisterId })" :class="{'bg-gray-700': route().current('club.accomplishment.quarterly')}" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-700 transition-colors duration-200 group">
                    <span class="text-md">Accomplishment Report</span>
                </Link>
            </div>
            <div v-if="isClubReportsGroupOpen" class="pl-8 space-y-2 mt-2">
